...
const DonorsList = () => {
  const { donors, filter, setFilter, onHandleClear } =
          ...
          filteredProducts?.map((datas) => (
            <div className="donor-card">
              <div className="card-header">
                ...
                <div className="blood-group">{datas.blood_group}</div>
              </div>
              <div className="card-body">
                <p>
                  <MapPinIcon /> <span>{datas.address}</span>
                </p>
                <p>
                  <PhoneIcon /> <span>{datas.phone}</span>
                </p>
                <p>
                  <ClockIcon /> <span>{datas.last_donate_date}</span>
                </p>
                <p>
                  <UserIcon /> <span>Any Time</span>
                </p>
              </div>
              <div className="card-actions">
                <button className="btn-connect" onClick={onHandleClear}>
                  Connect Now
                </button>
              </div>
            </div>
